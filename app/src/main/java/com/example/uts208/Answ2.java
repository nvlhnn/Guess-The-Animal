...
public class Answ2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_answ2);

        Intent intent = getIntent();
        mp = MediaPlayer.create(this, R.raw.gajah);
    ...
    public void read(View view) {
        stopP();
        Uri webpage = Uri.parse("https://id.wikipedia.org/wiki/Gajah");
